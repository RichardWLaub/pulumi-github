...
function transferProperties(onto, label, props) {
    ...
    for (const k of Object.keys(props)) {
        ...
        onto[k] = new output_1.Output(onto, debuggable_1.debuggablePromise(new Promise(resolve => resolveValue = resolve), `transferProperty(${label}, ${k}, ${props[k]})`), debuggable_1.debuggablePromise(new Promise(resolve => resolveIsKnown = resolve), `transferIsStable(${label}, ${k}, ${props[k]})`));
    }
    return resolvers;
}
