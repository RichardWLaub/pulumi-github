...
function prepareResource(label, res, custom, props, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const allDirectDependencyURNs = yield getResourceURNs(explicitDirectDependencies);
        ...
        for (const [propertyName, directDependencies] of propertyToDirectDependencies) {
            ...
            const urns = yield getResourceURNs(directDependencies);
...
function getResourceURNs(resources) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = new Set();
        for (const resource of resources) {
            result.add(yield resource.urn.promise());
        }
        return result;
    });
}
